...
INSERT INTO chatbot_files (id, chat_id, message_id, user_id, file_name, file_size, file_type, file_url) VALUES (:id, :chat_id, :message_id, :user_id, :file_name, :file_size, :file_type, :file_url);
