...
// Enhanced styled components for better doctor posts layout
      ...
      <EnhancedDoctorPostsContainer>
        ...
        {filteredPosts && filteredPosts.length > 0 ? (
          filteredPosts.map((post) => {
            ...
            return (
              <EnhancedPostContainer key={post.post_id}>
                <PostMetadata>
                ...
                <PostHeaderSection>
                  ...
                  <PostActionsSection>
                    <ViewPostButton onClick={() => handleViewPost(post.post_id)}>
                      <FaEye /> View
                    </ViewPostButton>
                    <EnhancedEditButton onClick={() => handleEditPost(post.post_id)}>
                      <FaEdit /> Edit
                    </EnhancedEditButton>
                    <EnhancedDeleteButton onClick={() => handleDeletePost(post.post_id)}>
                      <FaTrashAlt /> Delete
                ...
                {shouldShowButton && (
                  <ActionButtonContainer>
                    <ShowMoreButton onClick={() => toggleShowMore(post.post_id)}>
                      {isExpanded ? (
                        <>
